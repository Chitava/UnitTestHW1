...
public class Calculator {
    ...
    public static double calculatingDiscount(double purchaseAmount, int discountAmount) {
        ...
        if (discountAmount < 0 || discountAmount > 100 || result < 0) {
            throw new IllegalArgumentException("Не правильная скидка");
        }
        if (purchaseAmount < 0) {
            throw new ArithmeticException("Не верная сумма покупки");
        }
        return result;
    }
